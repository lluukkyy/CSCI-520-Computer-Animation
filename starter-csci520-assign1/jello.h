...
struct point 
{
  ...
  struct point operator+(struct point& another){
    struct point rc = {x+another.x, y+another.y, z+another.z};
    return rc;
  }
  ...
  struct point operator*(double s){
    struct point rc = {x*s, y*s, z*s};
    return rc;
  }
  ...
  struct point copy(){
    struct point rc = {x,y,z};
    return rc;
  }

  struct point cross(struct point another){
    struct point rc = {
